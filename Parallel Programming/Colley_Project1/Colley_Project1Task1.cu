...
//Meilin Liu
//12/12/24
//Programming Assignment #1 - Basic Matrix Addition
//Compiling command: nvcc Colley_Project1Task1.cu -o matrixAdd
...
__global__ void gpuMatrixAdd(int *a, int *b, int *c, int N) {
